# ardu_pde-generator by Bardynin Dmitry aka Eruman
# Astrakhan 2015-2018
			
gen::add_generator ardu_pde.org gen_ardu_pde::generate

namespace eval gen_ardu_pde {
...
proc make_callbacks { } {
    ...
    set cbks [ dict replace $cbks signature gen_ardu_pde::extract_signature ]
    set cbks [ dict replace $cbks body gen_ardu_pde::generate_body ]
...
proc mytranslit_declaration { texttrans } {
    ...
    set texttrans [ string map {"Программа" "draw" } $texttrans ]
