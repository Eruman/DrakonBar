...
proc make_callbacks { version } {
    ...
    gen::put_callback callbacks assign			gen_foxdot::assign
    gen::put_callback callbacks compare			gen_foxdot::compare
    gen::put_callback callbacks compare2		gen_foxdot::compare
    gen::put_callback callbacks while_start 	gen_foxdot::while_start
    gen::put_callback callbacks if_start		gen_foxdot::if_start
    gen::put_callback callbacks elseif_start	gen_foxdot::elseif_start
    gen::put_callback callbacks if_end			gen_foxdot::if_end
    gen::put_callback callbacks else_start		gen_foxdot::else_start
    gen::put_callback callbacks pass			gen_foxdot::pass
    gen::put_callback callbacks continue		gen_foxdot::p.continue
    gen::put_callback callbacks return_none		gen_foxdot::return_none
    gen::put_callback callbacks block_close		gen_foxdot::block_close
    gen::put_callback callbacks comment			gen_foxdot::commentator
    gen::put_callback callbacks bad_case		gen_foxdot::bad_case	
    gen::put_callback callbacks for_check		gen_foxdot::foreach_check
    gen::put_callback callbacks for_current		gen_foxdot::foreach_current	
    gen::put_callback callbacks body			gen_foxdot::generate_body
    gen::put_callback callbacks signature		gen_foxdot::extract_signature
    gen::put_callback callbacks and				gen_foxdot::p.and
    gen::put_callback callbacks or				gen_foxdot::p.or
    gen::put_callback callbacks not				gen_foxdot::p.not
    gen::put_callback callbacks break			"break"
    gen::put_callback callbacks declare		gen_foxdot::p.declare
    gen::put_callback callbacks for_declare gen_foxdot::foreach_declare
    gen::put_callback callbacks shelf gen_foxdot::shelf
    #item 6420001
    if {$version == 2} {
        #item 648
        gen::put_callback callbacks for_init		gen_foxdot::foreach_init
        gen::put_callback callbacks for_incr		gen_foxdot::foreach_incr
    } else {
        #item 6420002
        if {$version == 3} {
        ...
        #item 649
        gen::put_callback callbacks for_init		gen_foxdot::foreach_init3
        gen::put_callback callbacks for_incr		gen_foxdot::foreach_incr3
    }
    #item 650
    return $callbacks
}
