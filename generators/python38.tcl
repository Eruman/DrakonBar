gen::add_generator "PythonEXE 3.8" gen_py38::generate38
#Генератор для исполняемых скриптов PythonEXE3.8					\
предназначен для демонстрационного запуска диаграм,					\
использующих в качестве базового язык программирования Python 3.8.	\
Сообщения об ошибках не обрабатываются и не учитываются,			\
поэтому для анализа потребуется сторонний редактор файлов *.py 
    
namespace eval gen_py38 {
...
proc make_callbacks { version } {
    ...
    gen::put_callback callbacks assign			gen_py38::assign
    gen::put_callback callbacks compare			gen_py38::compare
    gen::put_callback callbacks compare2		gen_py38::compare
    gen::put_callback callbacks while_start 	gen_py38::while_start
    gen::put_callback callbacks if_start		gen_py38::if_start
    gen::put_callback callbacks elseif_start	gen_py38::elseif_start
    gen::put_callback callbacks if_end			gen_py38::if_end
    gen::put_callback callbacks else_start		gen_py38::else_start
    gen::put_callback callbacks pass			gen_py38::pass
    gen::put_callback callbacks continue		gen_py38::p.continue
    gen::put_callback callbacks return_none		gen_py38::return_none
    gen::put_callback callbacks block_close		gen_py38::block_close
    gen::put_callback callbacks comment			gen_py38::commentator
    gen::put_callback callbacks bad_case		gen_py38::bad_case	
    gen::put_callback callbacks for_check		gen_py38::foreach_check
    gen::put_callback callbacks for_current		gen_py38::foreach_current	
    gen::put_callback callbacks body			gen_py38::generate_body
    gen::put_callback callbacks signature		gen_py38::extract_signature
    gen::put_callback callbacks and				gen_py38::p.and
    gen::put_callback callbacks or				gen_py38::p.or
    gen::put_callback callbacks not				gen_py38::p.not
    gen::put_callback callbacks break			"break"
    gen::put_callback callbacks declare		gen_py38::p.declare
    gen::put_callback callbacks for_declare gen_py38::foreach_declare
    gen::put_callback callbacks shelf gen_py38::shelf
    #item 6420001
    if {$version == 2} {
        #item 648
        gen::put_callback callbacks for_init		gen_py38::foreach_init
        gen::put_callback callbacks for_incr		gen_py38::foreach_incr
    } else {
        #item 6420002
        if {$version == 3} {
        ...
        #item 649
        gen::put_callback callbacks for_init		gen_py38::foreach_init3
        gen::put_callback callbacks for_incr		gen_py38::foreach_incr3
    }
    #item 650
    return $callbacks
}
