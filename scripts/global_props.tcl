...
proc init { win data } {
	...
	set arrow_style_frame [ ttk::frame $root.arrow_style_frame ]
	set arrow_style_label [ ttk::label $arrow_style_frame.lang_label -text [ mc2 "Arrow style:" ] -width 30 ]
	set arrow_style_entry [ ttk::entry $arrow_style_frame.arrow_style_entry -textvariable mw::arrow_style -width 20 -validate key -validatecommand { gprops::color_changed %P } ]
	...
	pack $arrow_style_label -side left
	pack $arrow_style_entry -side left -padx 10
